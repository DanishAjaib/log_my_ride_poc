...
class ClubHomeScreen extends StatefulWidget {
  ...
  @override
  State<ClubHomeScreen> createState() => _RiderHomeScreenState();


}

class _RiderHomeScreenState extends State<ClubHomeScreen> {
          ...
          SingleChildScrollView(
            ...
            children: [
              ...
              HomeButton(
                  iconText: '1',
                  column2Children: [
                    getChipText('ACTIVE EVENT'),
                   const SizedBox(height: 5,),
                   Row(
                     children: [
                       const Icon(Icons.location_on, color: Colors.grey, size: 15,),
                       const SizedBox(width: 5,),
                       Text(faker.address.city(), style: const TextStyle(color: Colors.white, fontSize: 15),),
                     ],
                   ),
                   Row(
                     children: [
              ...
              HomeButton(
                  ...
                  iconText: '1',
                  column2Children: [
                    getChipText('FINANCIALS - MOST RECENT EVENT'),
                    const SizedBox(height: 5,),
                    Text(faker.vehicle.model(), style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold),),
                    Text('${getRandomDateTime()}', style: const TextStyle(color: Colors.grey, fontSize: 10),),
              ...
              HomeButton(
                  ...
                  column2Children: [
                    getChipText('MEMBERS'),
                    const SizedBox(height: 5,),
                    Text(faker.company.name(), style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold),),
                  ],
                  icon: null,
                image: 'assets/images/bike_image.jpg',
              ),
              ...
              HomeButton(
                iconText: '5',
                column2Children: [
                  getChipText('RECENT ACTIVITY'),
                  const SizedBox(height: 5,),
                  Text(faker.company.name(), style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold),),
                  Text('${faker.address.streetName()} - ${getRandomDateTime()}', style: const TextStyle(color: Colors.grey, fontSize: 10),),
                ],
                icon: null,
                image: 'assets/images/bike_image.jpg',
                onTap: () {
              ...
              HomeButton(
                  ...
                  column2Children: [
                    ...
                    const SizedBox(height: 5,),
                    Text(faker.person.name(), style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold),),
                    const Text('Secretary', style: TextStyle(color: Colors.grey, fontSize: 10,),),
                  ],
                  icon: null,
                image : 'assets/images/bike_image.jpg',
              ),
