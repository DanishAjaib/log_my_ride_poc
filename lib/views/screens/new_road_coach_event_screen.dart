...
class NewRideCoachEventScreen extends StatefulWidget {


  const NewRideCoachEventScreen({super.key});

  @override
  State<NewRideCoachEventScreen> createState() => _NewRideCoachEventScreenState();
}

class _NewRideCoachEventScreenState extends State<NewRideCoachEventScreen> {
                            ...
                            TextButton(
                              onPressed: () {
                                ...
                                FirebaseFirestore.instance.collection('rides').add({
                                  ...
                                  'eventType': 'Coach - Road',
                                  'eventCategory': _selectedTripCategoryType.first,
                                  'category': _selectedTripVisibilityType.first,
                                  'openTo': openTo,
                                  'visibility': _selectedTripVisibilityType.first,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      const Text('Min Ride Time per Ride'),
                                      TextButton(
                                        onPressed: () {
                                          showDialog(context: context, builder: (context) {
                                            return NumberSelectorDialog(
                                                title: 'Set Time (Mins)',
                                                initialValue: selectedRideTime,
                                                onNumberSelected: (value) {
                                              setState(() {
                                                selectedRideTime = value;
                                              });
                                            });
                                          });
                                        },
                                        style: TextButton.styleFrom(
                                            elevation: 0, shadowColor: Colors.transparent,
                                            textStyle: const TextStyle(color: primaryColor)),
                                        child: Text('$selectedRideTime mins', style: const TextStyle(color: Colors.white,),),
                                      )
                                    ],
                                  ),
                                ],
