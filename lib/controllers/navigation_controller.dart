...
class NavigationController extends GetxController {
  Rx<MapController> controller = MapController(
  ...
  void _listenToCurrentLocation() {
    geo.Geolocator.getPositionStream().listen((geo.Position position) {
     ...
     /* if (kDebugMode) {
      ...
      /*if(controller.value.ini) {
        controller.value.moveTo(GeoPoint(
  ...
  Future<void> drawRoad({required GeoPoint startPoint, required GeoPoint endPoint}) async {
  ...
  void drawCircle(CircleOSM circleOSM) {
    controller.value.drawCircle(circleOSM);
  }
