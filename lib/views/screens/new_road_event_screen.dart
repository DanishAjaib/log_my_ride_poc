...
class NewRideEventScreen extends StatefulWidget {


  const NewRideEventScreen({super.key});

  @override
  State<NewRideEventScreen> createState() => _NewRideEventScreenState();
}

class _NewRideEventScreenState extends State<NewRideEventScreen> {
                            ...
                            TextButton(
                              onPressed: () {
                                ...
                                FirebaseFirestore.instance.collection('rides').add({
                                  ...
                                  'arrivalTime': formatRideDuration(selectedRideTime),
