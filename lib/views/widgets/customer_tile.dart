...
class CustomerTile extends StatelessWidget {
  ...
  CustomerTile({super.key, required this.onPressed, required this.friend});
        ...
        child: ListTile(
          ...
          subtitle: Column(
            children: [
              ...
              Row(
                children: [
                  const Icon(Icons.alternate_email_outlined, size: 16, color: primaryColor,),
                  const SizedBox(width: 5),
                  Text(friend['email'], style: const TextStyle(fontSize: 12),),
                  const SizedBox(width: 10),
                  const Icon(Icons.event_available, size: 16, color: primaryColor,),
                  const SizedBox(width: 5),
                  Text('${(friend['events'])}', style: const TextStyle(fontSize: 12),),
