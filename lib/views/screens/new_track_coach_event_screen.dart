...
import 'package:log_my_ride/views/widgets/activities_widget.dart';
...
class NewTrackRideCoachEventScreen extends StatefulWidget {


  const NewTrackRideCoachEventScreen({super.key});

  @override
  State<NewTrackRideCoachEventScreen> createState() => _NewTrackRideCoachEventScreen();
}

class _NewTrackRideCoachEventScreen extends State<NewTrackRideCoachEventScreen> with SingleTickerProviderStateMixin {
                      ...
                      child: Column(
                        children: [
                         AppContainer(
                          ...
                          const SizedBox(height: 10,),
                          ActivitiesWidget(activities: activities , onChanged: (activities) {
                            setState(() {
